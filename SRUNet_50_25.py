...
def unet1(input_size):
    ...
    conv8 = Conv2D(1, 1, activation = 'relu', padding = 'same',)(conv7)  # 25
...
model2=load_model(cwd +'/SRUNet_100_50.h5', custom_objects={'custom_loss': custom_loss})  

# # copy layers of SRUnet_100_50 to my model
...
model1.layers[5].set_weights(model2.layers[5].get_weights())

model1.layers[7].set_weights(model2.layers[7].get_weights())
model1.layers[8].set_weights(model2.layers[8].get_weights())
model1.layers[9].set_weights(model2.layers[9].get_weights())

model1.layers[12].set_weights(model2.layers[12].get_weights())
model1.layers[13].set_weights(model2.layers[13].get_weights())
model1.layers[14].set_weights(model2.layers[14].get_weights())

model1.layers[17].set_weights(model2.layers[17].get_weights())
model1.layers[18].set_weights(model2.layers[18].get_weights())
model1.layers[19].set_weights(model2.layers[19].get_weights())

model1.layers[23].set_weights(model2.layers[23].get_weights())
model1.layers[24].set_weights(model2.layers[24].get_weights())
model1.layers[25].set_weights(model2.layers[25].get_weights())
model1.layers[26].set_weights(model2.layers[26].get_weights())
model1.layers[27].set_weights(model2.layers[27].get_weights())
...
while((i<epochs_max) and (stop==0)):
    ...
    for i21 in range(N1):
        ...
        print('SRUNet_50_25  iteration number   ',iter1,' sub-iter = ',i21+1)
    ...
    if(tr_Acc[iter1-1,1]>MAE_min):
        ...
        nb_min = 0
        model1.save(cwd +'/SRUNet_50_25.h5')
    ...
    np.save(cwd +'/tr_Acc_SRUNet_50_25',tr_Acc)
    np.save(cwd +'/Tr_runtime_SRUNet_50_25',time_Tr)
